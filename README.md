...
> **Note**
> Everywhere in this repository, make sure to replace `esteganobvio/chuncanos` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/esteganobvio/chuncanos/blob/main/scripts/README.md) for more information.
...
- First rebase to the image unsigned, to get the proper signing keys and policies installed:
  ```
  sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/esteganobvio/chuncanos:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/esteganobvio/chuncanos:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/esteganobvio/chuncanos:20230403
```
